    ...
    <div className='w-full h-full bg-[#d9d9d9]'>
      ...
      <div className='max-w-[1240px] mx-auto px-2 grid md:grid-cols-5 gap-8 pt-8'>
        ...
        <div className='flex flex-col'>
          <iframe width="560" height="315" src="https://www.youtube.com/embed/vaaGZO_HyVQ" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen;"></iframe>
